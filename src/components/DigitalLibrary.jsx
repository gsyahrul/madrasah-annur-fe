        ...
        <section className="section library" id="perpustakaan">
            <div className="container">
                ...
                <div className="library-grid">
                    {books.map((book, i) => (
                        <div className="book-card" key={`${activeTab}-${i}`}>
                            <div className="book-cover" style={{ background: `linear-gradient(135deg, ${book.color}, ${book.color}dd)` }}>
                                <div className="book-cover-pattern">
                                    <svg width="100%" height="100%">
                                        <pattern id={`pat-${activeTab}-${i}`} x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                                            <circle cx="20" cy="20" r="8" fill="rgba(255,255,255,0.3)" />
                                        </pattern>
                                        <rect width="100%" height="100%" fill={`url(#pat-${activeTab}-${i})`} />
                                    </svg>
                                </div>
