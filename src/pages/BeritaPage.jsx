                                ...
                                >
                                    ...
                                    <div style={{ padding: '1.5rem' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem', fontSize: '0.8rem', color: 'var(--gray-400)' }}>
                                            <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><FiCalendar /> {article.date_published || '-'}</span>
                                            <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}><FiUser /> {article.author || 'Admin'}</span>
                                        </div>
